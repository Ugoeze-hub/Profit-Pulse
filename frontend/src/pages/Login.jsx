        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold leading-tight">
              Your daily business intelligence, delivered like a WhatsApp message
            </h2>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <FiCheckCircle className="text-green-300" />
                <span>AI-powered insights in plain English or Pidgin</span>
              </div>
              <div className="flex items-center gap-3">
                <FiCheckCircle className="text-green-300" />
                <span>Understand where your money goes without accounting knowledge</span>
              </div>
              <div className="flex items-center gap-3">
                <FiCheckCircle className="text-green-300" />
                <span>Get daily summaries that actually make sense</span>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition-all"
                  />
                  <button
                    type="button"
